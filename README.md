...
Projeto de avaliação do modulo de JavaScript: DOM, eventos e Web Storage. Foi implementado uma página web que contém uma paleta de cores funcional que pode ser utilizada para criar desenhos em pixels.
